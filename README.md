...
## 64 teams/players support

This is a fork of [Hedgewars](https://hedgewars.org/) ([GitHub Mirror](https://github.com/hedgewars/hw)) that enables you to play with 64 teams and allows for up to 64 players this way.
It is based on discussions in the [Hedgewars Forum](https://www.hedgewars.org/node/6956) and is not tested at all, yet.

### available Packages

#### Flatpak

- Download and Run from [Releases](https://github.com/yeoldegrove/hedgewars64/releases)
- e.g.

```bash
curl -LO https://github.com/yeoldegrove/org.hedgewars.Hedgewars64/releases/download/1.0.3-unstable-2025-06-26/org.hedgewars.Hedgewars64-x86_64.flatpak
flatpak --user install org.hedgewars.Hedgewars64-x86_64.flatpak
flatpak run org.hedgewars.Hedgewars64
```

#### Nix

```bash
nix run github:yeoldegrove/hedgewars64
```
